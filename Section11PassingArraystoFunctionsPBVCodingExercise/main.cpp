...
string print_guest_list(const std::string[], size_t value);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
void clear_guest_list(std::string[], size_t value);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
