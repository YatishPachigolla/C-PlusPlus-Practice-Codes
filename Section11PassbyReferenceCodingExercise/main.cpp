...
string print_guest_list(const string &s1, const string &s2, const string &s3);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
void clear_guest_list(string &s1, string &s2, string &s3);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
